...
@section('content')
    ...
    <div class="upcoming_wrapper dm_cover" style="background-image: url({{env('PUBLIC_PATH')}}/{{$config_data['event_background']}});">
        <div class="club_video_overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12">
...
{{--                                        <p><i class="fas fa-comment-alt"></i>&nbsp;<a href="#">04 Comm.</a></p>--}}
    ...
    <div class="news_letter_wrapper dm_cover" id="subscriber">
        <div class="club_video_overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12">
