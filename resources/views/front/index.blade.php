...
@section('content')
    ...
    <div class="displaynone audi_track_wrapper dm_cover">
    ...
    <div class="displaynone feedback_wrapper dm_cover" style="background-image: url({{env('PUBLIC_PATH')
    }}/{{$config_data['feedback_background']}});">
        <div class="club_video_overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12">
